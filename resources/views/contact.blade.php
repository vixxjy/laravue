				...
				<div id="headwrap">
					...
					<div id="titlelogo">
						<a href="https://cdainterview.com/">
							<div id="logo"><img src="rw_common/images/bemo-logo2.png" width="167" height="100"
									alt="Site logo" /></div>
							<h1></h1>
						</a>
						<h2></h2>
					...
					<div id="nwrap">
						...
						<nav>
							<ul class="navigation">
								<li><a href="/" rel="self">Main</a></li>
								<li id="current"><a href="/contact" rel="self" id="current">Contact Us</a></li>
							</ul>
						</nav>
					</div>
				</div>
				...
				<div id="padding">
					<div class="message-text"><span style="font-size:17px; font-weight:bold; ">BeMo Academic Consulting
							Inc. </span><br /><span><span style="font-size:13px; font-weight:bold; "><u>Toll
								...
								style="font-size:13px; ">: </span><span style="font-size:14px; "><a
									...
									data-cfemail="87eee9e1e8c7e5e2eae8e6e4e6e3e2eaeee4e4e8e9f4f2ebf3eee9e0a9e4e8ea">[email&#160;protected]</a></span>
					</div><br />
					...
					<form action="./contact-us_files/mailer.php" method="post" enctype="multipart/form-data">
						<div>
							...
							<input type="hidden" name="form_token" value="15680952705fb559bb9a5bb" />
					...
					<div class="form-footer"><span style="font-size:15px; font-weight:bold; "><u>Note</u></span><span
							...
							send us an email to <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
								data-cfemail="bbd2d5ddd4fbd9ded6d4dad8dadfded6d2d8d8d4d5c8ced7cfd2d5dc95d8d4d6">[email&#160;protected]</a>
